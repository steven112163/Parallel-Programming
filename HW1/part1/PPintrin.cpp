...
void _pp_vadd_float(__pp_vec_float &vecResult, __pp_vec_float &veca, __pp_vec_float &vecb,
                    __pp_mask &mask) { _pp_vadd<float>(vecResult, veca, vecb, mask); }
...
void _pp_vsub_float(__pp_vec_float &vecResult, __pp_vec_float &veca, __pp_vec_float &vecb,
                    __pp_mask &mask) { _pp_vsub<float>(vecResult, veca, vecb, mask); }
...
void _pp_vmult_float(__pp_vec_float &vecResult, __pp_vec_float &veca, __pp_vec_float &vecb,
                     __pp_mask &mask) { _pp_vmult<float>(vecResult, veca, vecb, mask); }
...
void _pp_vdiv_float(__pp_vec_float &vecResult, __pp_vec_float &veca, __pp_vec_float &vecb,
                    __pp_mask &mask) { _pp_vdiv<float>(vecResult, veca, vecb, mask); }
